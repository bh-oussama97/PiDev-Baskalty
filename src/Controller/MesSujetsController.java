...
public class MesSujetsController implements Initializable {
     ...
     */
     ...
     private static events sujet_modifié = new events();
    ...
    public void initialize(URL url, ResourceBundle rb) {
     ...
     private void loadUserGrid() throws SQLException {
		List<events> sujets = fetchForumsByIdUser();
	...
	private List<events> fetchForumsByIdUser() throws SQLException {
		try {
	...
	private EventHandler<MouseEvent> DeleteEventHandler(events sujet, int index) {
		return event -> {
			                 System.out.println(sujet.getId_Event());
                                         
                  sujetService.supprimerEvent(sujet);
        ...
        private EventHandler<MouseEvent> UpdateEventHandler(events sujet, int index) {
		return event -> {
