...
public class ProduitsVendeurController implements Initializable {
        ...
        private void ContenuChaquePage(int i) throws IOException, SQLException 
    {
        ...
        if (TroisProduitsParPage.size() >= 1) 
        {
            ...
            categorie1.setText(sc.getCategorieNameById(TroisProduitsParPage.get(0).getCategorie()));
            nom1.setText(TroisProduitsParPage.get(0).getNom());
            prix1.setText(Integer.toString(TroisProduitsParPage.get(0).getPrix()) + "DT");
        ...
        if (TroisProduitsParPage.size() >= 2) 
        {
            ...
            categorie2.setText(sc.getCategorieNameById(TroisProduitsParPage.get(1).getCategorie()));
            nom2.setText(TroisProduitsParPage.get(1).getNom());
            prix2.setText(Integer.toString( TroisProduitsParPage.get(1).getPrix()) + "DT");
         ...
         if (TroisProduitsParPage.size() >= 3) 
        {
            ...
            categorie3.setText(sc.getCategorieNameById(TroisProduitsParPage.get(2).getCategorie()));
            nom3.setText(TroisProduitsParPage.get(2).getNom());
            prix3.setText(Integer.toString(TroisProduitsParPage.get(2).getPrix()) + "DT");
