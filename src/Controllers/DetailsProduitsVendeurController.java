...
public class DetailsProduitsVendeurController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
     ...
     public void SetItemsDetails() throws SQLException
     {
         ServiceCategorie sc = new ServiceCategorie();
           nom.setText(pdetails.getNom());
        reference.setText(pdetails.getReference());
        categorie.setText(sc.getCategorieNameById(pdetails.getCategorie()));
   ...
   @FXML
    ...
    private void supprimer(ActionEvent event) throws IOException {
          ...
          alert.setContentText("Product number: " +pdetails.getId());
        ...
        TrayNotification tray = new TrayNotification("Notification !", "Product Deleted !", NotificationType.SUCCESS);
