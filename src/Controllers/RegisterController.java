...
observableArrayList("Internaute");
    ...
    private void register(ActionEvent event) throws SQLException, IOException {
        ...
        String req= "INSERT INTO fos_user (username,email,password,roles,username_canonical,email_canonical ) VALUES (?,?,?,?,?,?)";
        ...
        prs.setString(5, username.getText());
        prs.setString(6,email.getText());
