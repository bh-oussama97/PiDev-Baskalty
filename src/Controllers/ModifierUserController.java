...
public class ModifierUserController implements Initializable {
    ...
    @FXML
    private AnchorPane modifierRetour;
    @FXML
    private AnchorPane retourversAccueilUser;
    ...
    public void initialize(URL location, ResourceBundle resources) {
      ...
      setPassword(LoginController.getInstance().password());
      
      ChoiceBox.setValue(LoginController.getInstance().Role());
    }
   ...
   /* private void handleMouseEvenet(MouseEvent event) throws IOException{
    ...
    @FXML
    private void RetourVersAccueil(MouseEvent event) throws IOException {
        
          
          FXMLLoader Loader = new FXMLLoader();
            Loader.setLocation(getClass().getResource("/com/pidev/views/AcceuilUser.fxml"));
            
            Parent  par = Loader.load();
            
       
              AnchorPane pane = (AnchorPane) retourversAccueilUser.getParent();
