...
public class GererProduitsVendeurController implements Initializable {
          ...
          private void ContenuChaquePage(int i) throws IOException 
    {
         ...
         if (TroisProduitsParPage.size() >= 4)
        {
            ...
            categorie4.setText(TroisProduitsParPage.get(3).getCategorie());
            reference4.setText(TroisProduitsParPage.get(3).getReference());
            prix4.setText(Float.toString(TroisProduitsParPage.get(3).getPrix()));
        }
        else 
        {
            box4.setVisible(false);
    ...
    public void details1(ActionEvent event) throws IOException
    {
