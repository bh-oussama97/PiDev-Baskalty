...
import com.pidev.controllers.CodeController;
...
public class ForgetController implements Initializable {
    ...
    public static final String AUTH_TOKEN = "c276a7f55a874047dee645ec24ac2bfe";
    ...
    public void initialize(URL url, ResourceBundle rb) {
        String VUrl = getClass().getResource("/images/a.mp4").toExternalForm();
    ...
    private void SendMail(ActionEvent event) throws SQLException, AddressException, MessagingException, IOException {
      ...
      com.twilio.rest.api.v2010.account.Message messages = com.twilio.rest.api.v2010.account.Message.creator(new PhoneNumber("+21658900333"),
        new PhoneNumber("+12055257169"), y).create();
        ...
        return new PasswordAuthentication(from,pass);
          ...
          //compose message                
           ...
           mediaplayer.stop();
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/pidev/views/Code.fxml"));
