 ...
 public void setEmail(String email) {
  ...
  public void setCode(String code) {
    ...
    private void SendMail(ActionEvent event) throws AddressException, MessagingException, SQLException, IOException  {
       ...
       String from ="chebby.cyrine29@gmail.com";
       String pass="58900333"; 
       String [] to={this.email};
       String host="mail.javatpoint.com";
       String sub="Password Recovery Baskelty Team";
        ...
        return new PasswordAuthentication(from,pass);
          ...
          //compose message                
           ...
           new PhoneNumber("+12055257169"), mesg).create();
         
            Node node =(Node)event.getSource();
            stage = (Stage)node.getScene().getWindow();
            stage.close();
            Scene scene = new Scene(FXMLLoader.load(getClass().getResource("/com/pidev/views/LognMain.fxml")));
