 ...
 * @author benha
 */
public class PageAccueilMecaniciensController implements Initializable {
   ...
   private void setNode (Node node)
   {
	...
	public void createPage() {
        ...
        try {
            ajouter = FXMLLoader.load(getClass().getResource("/com/pidev/views/AjoutMecanicien.fxml"));
            setNode(ajouter);
        } catch (IOException ex) {
            Logger.getLogger(PageAccueilMecaniciensController.class.getName()).log(Level.SEVERE, null, ex);
        }
	}
    ...
    private void ListeProduits(ActionEvent event) {
          ...
          try {
            ...
            Parent root = FXMLLoader.load(getClass().getResource("/com/pidev/views/ListeMecaniciens.fxml"));
